 ...
 * @author Sai 支持自动翻页
 */
public class ConvenientBanner<T, E> extends LinearLayout {
    ...
    public ConvenientBanner setPages(CBViewHolderCreator holderCreator, List<T> datas, List<E> texts){
        this.mDatas = datas;
        pageAdapter = new CBPageAdapter(holderCreator, mDatas, texts);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        boolean handledEvent = super.dispatchTouchEvent(ev);
        if (handledEvent)
